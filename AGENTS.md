...
This project is indexed by GitNexus as **portfolio** (111 symbols, 156 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
